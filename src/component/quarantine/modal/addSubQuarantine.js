...
export default function AddSubQuarantine({ open, setOpen, quarantineId }) {
    ...
    const onFinish = (values) => {
        ...
        subQuarantineDataDispatch({ type: 'ADD_SUB_QUARANTINE', payload: {...values, quarantineId: quarantineId} })
